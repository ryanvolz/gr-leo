...
#ifndef INCLUDED_LEO_MONOPOLE_ANTENNA_H
#define INCLUDED_LEO_MONOPOLE_ANTENNA_H
 ...
 */
class LEO_API monopole_antenna : virtual public generic_antenna {
...
#endif /* INCLUDED_LEO_MONOPOLE_ANTENNA_H */
